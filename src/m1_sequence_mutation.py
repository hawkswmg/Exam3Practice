...
def run_test_zero_changer():
    ...
    # Test 2:
    test2 = ([0, 4, 1], [9, 9, 9], [0, 3], [0, 0, 0, 0, 2])
    expected2 = ([1, 4, 1], [9, 9, 9], [2, 3], [3, 4, 5, 6, 2])
    zero_changer(test2)
    print()
    print('Test 2:')
    ...
    # Test 3:
    test3 = ([4, 5, 0, 3], [88, 0, 8, 0, 0], [3, 0, 1], [0])
    expected3 = ([4, 5, 1, 3], [88, 2, 8, 3, 4], [3, 5, 1], [6])
    zero_changer(test3)
    print()
    print('Test 3:')
